...
public class UserFunctionExamples {
  public static void addUserFunctions(final Environment theEnv) {
    // (upcase "ßuzäöü")
    theEnv.removeUserFunction("upcase");
    theEnv.addUserFunction("upcase", "syn", 1, 1, "syn", new UserFunction() {
    ...
    theEnv.addUserFunction("lowcase", "syn", 1, 1, "syn", new UserFunction() {
      public PrimitiveValue evaluate(List<PrimitiveValue> arguments) {
        LexemeValue rv = (LexemeValue) arguments.get(0);
    ...
    theEnv.addUserFunction("cbrt", "d", 1, 1, "ld", new UserFunction() {
      public PrimitiveValue evaluate(List<PrimitiveValue> arguments) {
    ...
    theEnv.addUserFunction("get-year", "v", 0, 0, null, new UserFunction() {
      public PrimitiveValue evaluate(List<PrimitiveValue> arguments) {
        Calendar theCalendar = new GregorianCalendar();
        return new IntegerValue(theCalendar.get(Calendar.YEAR));
      }
    });

    theEnv.addUserFunction("get-properties", "m", 0, 0, null, new UserFunction() {
      public PrimitiveValue evaluate(List<PrimitiveValue> arguments) {
    ...
    theEnv.addUserFunction("hello", "v", 0, 0, null, new UserFunction() {
      public PrimitiveValue evaluate(List<PrimitiveValue> arguments) {
    ...
    theEnv.addUserFunction("make-instoid", "bi", 0, 0, null, new UserFunction() {
      public PrimitiveValue evaluate(List<PrimitiveValue> arguments) {
        try {
    ...
    theEnv.addUserFunction("make-factoid", "bf", 0, 0, null, new UserFunction() {
      public PrimitiveValue evaluate(List<PrimitiveValue> arguments) {
        try {

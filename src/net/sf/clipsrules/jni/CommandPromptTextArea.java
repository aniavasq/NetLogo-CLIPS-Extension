...
public class CommandPromptTextArea extends RouterTextArea implements PeriodicCallback {
  /**
   *
   */
  ...
  /*************************/
  public CommandPromptTextArea(Environment theEnv) {
    super(theEnv);
  ...
  /*******************************/
  public void addCommandExecutionListener(CommandExecutionListener theListener) {
  ...
  /**********************************/
  public void removeCommandExecutionListener(CommandExecutionListener theListener) {
  ...
  /*********************************/
  public void callExecutionCommandListeners(String command, String event) {
  ...
  public void keyTyped(KeyEvent e) {
    ...
    // if ((e.getModifiers() & (KeyEvent.ALT_MASK | KeyEvent.CTRL_MASK | KeyEvent.META_MASK)) != 0) {
    if ((e.getModifiersEx() & (KeyEvent.ALT_DOWN_MASK | KeyEvent.CTRL_DOWN_MASK | KeyEvent.CTRL_DOWN_MASK)) != 0) {
      return;
    }
  ...
  /* modifyCommand */
  /*****************/
  protected void modifyCommand(String replaceString, boolean isDelete) {
    int textLength = this.getText().length();
    int commandLength = (int) clips.getInputBuffer().length();
    int lockedLength = textLength - commandLength;
    ...
    String newCommand = this.getText().substring(lockedLength, left) + replaceString + this.getText().substring(right);
  ...
  /* doExecuteCommand */
  /********************/
  private void doExecuteCommand(String executingCommand) {
  ...
  private void updateCommandHistory() {
    ...
    if ((commandHistory.size() > 1) && (commandHistory.get(0).equals(commandHistory.get(1)))) {
  ...
  /* replaceCommand */
  /******************/
  public void replaceCommand(String newCommand) {
    /* ============================================= */
    /* Remove the current command from the window. */
    /* ============================================= */

...
public class RouterTextArea extends JTextArea
    implements Router, KeyListener, CaretListener, FocusListener, DropTargetListener, ActionListener {
  /**
   *
   */
  ...
  /* RouterTextArea */
  /******************/
  public RouterTextArea(Environment theEnv) {
    clips = theEnv;
    ...
    this.setBorders(
        BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(Color.white, 3),
  ...
  /* setBorder */
  /*************/
  public void setBorders(Border theInactiveBorder, Border theActiveBorder) {
  ...
  /* appendChars */
  /***************/
  public synchronized boolean appendChars(String theString) {
    if (!charNeeded)
      return false;
  ...
  /* pushChar */
  /************/
  public synchronized int pushChar(int theChar) {
  ...
  public synchronized int requestChar() {
    ...
    if ((clips.getInputBufferCount() == 0) && (charList.size() != 0)) {
      charList.clear();
    }
  ...
  /* supplyChar: */
  /***************/
  public synchronized boolean supplyChar(char theChar) {
    if (!charNeeded)
      return false;
  ...
  public boolean query(String logName) {
    if (logName.equals(STDOUT) || logName.equals(STDIN) || logName.equals(STDWRN) || logName.equals(STDERR))
  ...
  /* createTimer: */
  /****************/
  private synchronized boolean createTimer(String printString) {
  ...
  public void keyPressed(KeyEvent e) {
    ...
    if ((theChar == KeyEvent.VK_BACK_SPACE) || (theChar == KeyEvent.VK_DELETE)) {
      e.consume();
    }
  }
  ...
  public void keyTyped(KeyEvent e) {
    // if ((e.getModifiers() & (KeyEvent.ALT_MASK | KeyEvent.CTRL_MASK | KeyEvent.META_MASK)) != 0) {
  ...
  protected void dragUnderFeedback(DropTargetDragEvent dtde, boolean acceptedDrag) {
    if ((dtde != null) && acceptedDrag) {
      ...
      this.getCaret().setVisible(true);
      this.setCaretPosition(this.viewToModel2D(location));
    } else {
      this.getCaret().setVisible(false);
    }
  }
  ...
  protected boolean acceptOrRejectDrag(DropTargetDragEvent dtde) {
    ...
    int caretPosition = this.viewToModel2D(location);

    /* =============================================== */
    /* Drag is only valid in a specific caret range. */
    /* =============================================== */

    if ((caretPosition < dragTargetCaretStart()) || (caretPosition > dragTargetCaretEnd())) {
      dtde.rejectDrag();
      return false;
    }
  ...
  /* caretUpdateAction */
  /*********************/
  protected void caretUpdateAction(final int dot, final int mark) {
    /* ============================================== */

...
public class CLIPSLoadException extends CLIPSException {
  ...
  public CLIPSLoadException(List<CLIPSLineError> list) {
    super();
    errorList = new ArrayList<CLIPSLineError>(list);
  }

  public CLIPSLoadException(String message, List<CLIPSLineError> list) {
    super(message);
    errorList = new ArrayList<CLIPSLineError>(list);
  }

  public CLIPSLoadException(String message, Throwable cause, List<CLIPSLineError> list) {
    super(message, cause);
    errorList = new ArrayList<CLIPSLineError>(list);
  }

  public CLIPSLoadException(Throwable cause, List<CLIPSLineError> list) {
    super(cause);
    errorList = new ArrayList<CLIPSLineError>(list);
  }
